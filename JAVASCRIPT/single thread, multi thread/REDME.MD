...
# scope chain.
    ...
    When accessing a variable, JavaScript searches for the variable in the current scope. If it's not found, it searches in the outer scope, continuing up to the global scope. This chain of scopes is known as the scope chain.

# scope

    scope refers to the accessibility of variables, functions, and objects in a specific part of the code. It determines where a variable or function is accessible and whether it can be referenced or modified. Understanding scope is crucial for writing error-free and maintainable code.
